...
import firebaseOHillRef from "./App.js";

//var firebaseOHillRef = database().ref("OHill");
...
class OhillMenu extends Component {
  ...
  handleSubmit = submit => {
    ...
    //debugger;
    firebase.database.ref("OHill").set(this.state.entries);
  };

  //Retrieves current rating info from Firebase
  componentWillMount() {
    firebaseOHillRef.on("value", snapshot => {
